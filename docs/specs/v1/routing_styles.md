...
Routa supports both directory-style routes and flat dot routes. Both styles resolve into the same route graph.
...
Directory and flat route files are just authoring styles. Once parsed, Routa should treat them identically.
