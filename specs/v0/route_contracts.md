...
Trail route files define the HTTP boundary. They consume Zod schemas, define method contracts, run route handlers, and map typed handler outcomes into HTTP responses. Application business logic remains outside Trail.
