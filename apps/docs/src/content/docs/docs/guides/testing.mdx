...
<Aside type="note" title="No test helper package in v0">
	Routa does not ship a dedicated testing utility yet. The examples above use only Vitest,
	`createHonoApp`, and your route modules.
</Aside>
