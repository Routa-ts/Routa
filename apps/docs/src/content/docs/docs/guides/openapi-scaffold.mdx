...
<Aside type="caution" title="Generated source is yours">
	Scaffolding is a one-way import, not a live binding. After the first run, the route
	files are your source of truth and the document is regenerated from them.
</Aside>
