...
<CardGrid>
	...
	<Card title="Project anatomy" icon="folder-open" href="/getting-started/project-anatomy/">
		Learn the files Routa owns and the files your app owns.
	</Card>
	<Card title="Route contracts" icon="document" href="/concepts/route-contracts/">
		Learn the source-of-truth model for Routa HTTP boundaries.
	</Card>
	<Card title="Scaffold from OpenAPI" icon="open-book" href="/guides/openapi-scaffold/">
